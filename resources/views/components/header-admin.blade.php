    ...
    <div class="flex items-center gap-3">
        ...
        <div class="relative">
            <button id="dropdownBtn" class="flex items-center cursor-pointer hover:text-light1 dark:hover:text-dark1">
                <img src="{{ Auth::user()->avatar }}" alt="Profile" class="w-8 h-8 rounded-full me-[2px]">
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z" /></svg>
            </button>
            <div id="dropdownMenu" class="hidden absolute right-0 text-[14px] p-2 mt-2 w-44 space-y-1 rounded-md border border-light5 dark:border-dark5 shadow-lg z-50 bg-light7 dark:bg-dark7">
                ...
                <a href="{{ route('admin.profile') }}" class="flex items-center gap-3 px-3 py-2 hover:bg-light8 hover:text-light1 dark:hover:bg-dark8 dark:hover:text-dark1 rounded transition-all duration-200 {{ request()->routeIs('admin.profile') ? 'bg-light8 text-light1 dark:bg-dark8 dark:text-dark1' : '' }}">
