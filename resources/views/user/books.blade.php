        ...
        <div class="flex gap-5 w-max">
            <div class="flex w-56 flex-col gap-3 p-3 rounded-md border border-light5 dark:border-dark5">
                ...
                <div class="flex items-center gap-5">
                    <a href="#" class="cursor-pointer text-[14px] px-5 py-1.5 rounded-md bg-light1 text-light7 hover:bg-light2 dark:bg-dark1 dark:text-dark7 dark:hover:bg-dark2 transition-all duration-200">Pinjam Sekarang</a>
