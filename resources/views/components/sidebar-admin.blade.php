<aside id="sidebar" class="flex flex-col fixed left-2 h-[98%] bottom-2 w-64 z-40 p-4 bg-light7 rounded-md dark:bg-dark7 border border-light5 dark:border-dark5">
    ...
    <nav class="flex flex-col justify-between flex-1 font-raleway font-semibold">
        <div class="space-y-2">
            <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2 py-2.5 px-3.5 rounded transition-all duration-200 hover:bg-light8 hover:text-light1 dark:hover:bg-dark8 dark:hover:text-dark1 {{ request()->routeIs('admin.dashboard') ? 'bg-light8 text-light1 dark:bg-dark8 dark:text-dark1' : '' }}">
            ...
            <a href="{{ route('admin.manage-books') }}" class="flex items-center gap-2 py-2.5 px-3.5 rounded transition-all duration-200 hover:bg-light8 hover:text-light1 dark:hover:bg-dark8 dark:hover:text-dark1 {{ request()->routeIs('admin.manage-books') || request()->routeIs('admin.books.edit') ? 'bg-light8 text-light1 dark:bg-dark8 dark:text-dark1' : '' }}">
            ...
            @endif
            <a href="{{ route('admin.manage-queues') }}" class="flex items-center gap-2 py-2.5 px-3.5 rounded transition-all duration-200 hover:bg-light8 hover:text-light1 dark:hover:bg-dark8 dark:hover:text-dark1 {{ request()->routeIs('admin.manage-queues') ? 'bg-light8 text-light1 dark:bg-dark8 dark:text-dark1' : '' }}">
            ...
            <a href="{{ route('admin.manage-loans') }}" class="flex items-center gap-2 py-2.5 px-3.5 rounded transition-all duration-200 hover:bg-light8 hover:text-light1 dark:hover:bg-dark8 dark:hover:text-dark1 {{ request()->routeIs('admin.manage-loans') ? 'bg-light8 text-light1 dark:bg-dark8 dark:text-dark1' : '' }}">
        ...
        <div class="space-y-2">
            <a href="{{ route('admin.profile') }}" class="flex items-center gap-2 py-2.5 px-3.5 rounded transition-all duration-200 hover:bg-light8 hover:text-light1 dark:hover:bg-dark8 dark:hover:text-dark1 {{ request()->routeIs('admin.profile') ? 'bg-light8 text-light1 dark:bg-dark8 dark:text-dark1' : '' }}">
