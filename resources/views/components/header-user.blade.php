    ...
    <div class="flex items-center gap-3">
        ...
        <div class="relative">
            ...
            <div id="dropdownMenu" class="hidden absolute right-0 text-[14px] p-2 mt-2 w-44 space-y-1 rounded-md border border-light5 dark:border-dark5 shadow-lg z-50 bg-light7 dark:bg-dark7">
                ...
                <a href="{{ route('user.profile') }}" class="flex items-center gap-3 px-3 py-2 hover:bg-light8 hover:text-light1 dark:hover:bg-dark8 dark:hover:text-dark1 rounded transition-all duration-200 {{ request()->routeIs('user.profile') ? 'bg-light8 text-light1 dark:bg-dark8 dark:text-dark1' : '' }}">
