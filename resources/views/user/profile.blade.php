            ...
            <div class="grid grid-cols-[1fr_3.5fr] gap-5 items-center text-[15px]">
                ...
                <div>
                    <div class="grid grid-cols-2 gap-y-4 gap-x-5 text-[15px] mb-6">
                        @include('components.input-readonly', ['label' => 'Nama Lengkap', 'value' => $user->name])
                        @include('components.input-readonly', ['label' => 'Username', 'value' => $user->username])
                        @include('components.input-readonly', ['label' => 'NIM', 'value' => $user->identifier])
                        @include('components.input-editable', ['label' => 'Email', 'name' => 'email', 'value' => $user->email])
                        @include('components.input-editable', ['label' => 'No. HP', 'name' => 'phone', 'value' => $user->phone])
                    </div>
